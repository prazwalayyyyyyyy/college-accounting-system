...
void main(void)
{
    ...
    printf("                   \t|                                                              |\n");
    printf("                   \t|   !!!!!WELCOME TO COLLEGE ACCOUNTING SYSTEM PROJECT!!!!!     |\n");
    printf("                   \t|      DEVELOPED BY BE COMPUTER 3RD SEMESTER BATCH 2017        |\n");
    printf("                   \t|                   -AAJU CHANDRA SHRESTHA                     |\n");
    printf("                   \t|                   -ALIZ ACHARYA                              |\n");
    printf("                   \t|                   -ABIN RAJ KC                               |\n");
    printf("                   \t|                   -DIPAK PANDIT                              |\n");
    printf("                   \t|______________________________________________________________|\n");
    ...
    system("color 0");
    printf("\n\n\t || WELCOME TO COLLEGE ACCOUNTING SYSTEM PROJECT  || \n\n\n");
    for(i=0; i<80; i++)
    {
        printf("#");
    }
...
void addrec(int j)
{
    ...
    if (j==2)
    {
        while(c=='y'||c=='Y')
        {
            ...
            fflush(stdin);
            scanf("%d",&tech.id);
            printf("\nEnter number of shift per month:: ");
            scanf("%d",&tech.no);
            fflush(stdin);
        ...
        while(c=='y'||c=='Y')
        {
            ...
            while(fread(&tech,sizeof(tech),1,ft)==1)
            {
                if (strcmpi(name,tech.n)==0)
                {
                    ...
                    fflush(stdin);
                    scanf("%d",&tech.id);
                    printf("\nEnter new shift per month of teacher: ");
                    fflush(stdin);
                    scanf("%d",&tech.no);
...
void ext()
{
    ...
    system("cls");
    printf("\n\n\t\t Thanks for using our College Accounting System. .\n\n");
    system("pause");
    system("cls");
    printf("\n\n\t\t\t Exiting In A Moment\n\n");
    for(i=1; i<=60; i++)
